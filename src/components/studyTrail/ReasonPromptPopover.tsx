  ...
  return (
    ...
    >
      <div style={{ width: 340, background: 'rgb(var(--color-surface-2))', border: '1px solid rgb(var(--color-surface-4))', borderRadius: 12, padding: 16, boxShadow: '0 20px 60px rgba(0,0,0,0.5)' }}>
        <div style={{ fontSize: 13, fontWeight: 600, color: 'rgb(var(--color-text-primary))', marginBottom: 4 }}>Why did you jump here?</div>
        ...
        <div style={{ display: 'flex', gap: 8, marginBottom: 10 }}>
          <div style={{ flex: 1 }}>
            <label style={{ fontSize: 10, color: 'rgb(var(--color-text-muted))', display: 'block', marginBottom: 3 }}>Verse (from)</label>
            <input
          ...
          <div style={{ flex: 1 }}>
            <label style={{ fontSize: 10, color: 'rgb(var(--color-text-muted))', display: 'block', marginBottom: 3 }}>Verse (to)</label>
            <input
