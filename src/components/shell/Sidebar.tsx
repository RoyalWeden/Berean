        ...
        <div className="px-2 pt-1 pb-1 flex-shrink-0">
          <div className="no-drag flex items-center gap-1">
            ...
            <button
              ...
              className="flex-1 flex items-center gap-1.5 px-2 py-1.5 rounded-shell bg-[rgb(var(--color-surface-4))] hover:bg-[rgb(var(--color-accent))/15] hover:text-[rgb(var(--color-text-primary))] text-left transition-colors cursor-pointer min-w-0"
            >
            ...
            <Tooltip.Root>
              <Tooltip.Trigger asChild>
                <button
                  ...
                  className="p-1.5 rounded-shell bg-[rgb(var(--color-surface-4))] hover:bg-[rgb(var(--color-accent))/25] hover:text-[rgb(var(--color-accent))] text-[rgb(var(--color-text-muted))] transition-colors cursor-pointer flex-shrink-0"
                >
                  <Plus size={14} />
                </button>
              </Tooltip.Trigger>
            ...
            <Tooltip.Root key={id}>
              <Tooltip.Trigger asChild>
                <button
                  ...
                  className="no-drag group relative flex-1 flex items-center justify-center aspect-square max-h-9 rounded-shell bg-[rgb(var(--color-surface-4))] text-[rgb(var(--color-text-muted))] hover:text-[rgb(var(--color-accent))] hover:bg-[rgb(var(--color-accent))/25] transition-colors cursor-pointer overflow-hidden"
                >
