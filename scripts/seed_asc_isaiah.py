"""
seed_asc_isaiah.py — Reseed asc_isaiah.db from R.H. Charles 1913 critical edition
Source: https://www.earlychristianwritings.com/text/ascension.html
"""
import sqlite3, os, shutil

DB     = '/Users/roywe/Berean/data/asc_isaiah.db'
BAK    = '/Users/roywe/Berean/data/asc_isaiah.db.bak'

# ── ECW / R.H. Charles 1913 verse data ──────────────────────────────────────

VERSES = {
    1: [
        (1,  "AND it came to pass in the twenty-sixth year of the reign of Hezediah king of Judah that he called Manasseh his son."),
    ...
    2: [
        (1,  "AND it came to pass after that Hezekiah died and Manasseh became king, that he did not remember the commands of Hezekiah his father, but forgat them, and Sammael abode in Manasseh and clung fast to him."),
        ...
        (5,  "And witchcraft and magic increased and divination and auguration, and fornication, and adultery, and the persecution of the righteous by Manasseh and Tobia the Canaanite, and John of Anathoth, and Zadok the chief of the works."),
        ...
        (14, "And Elijah the prophet of Tebon of Gilead was reproving Ahaziah and Samaria, and prophesied regarding Ahaziah that he should die on his bed of sickness, and that Samaria should be delivered into the hand of Leba Nasr because he had slain the prophets of God."),
    ...
    3: [
        ...
        (2,  "And it came to pass when Alagar Zagar, king of Assyria, had come and taken captive, and led them away to the mountains of the Medes and the rivers of Tazon"),
    ...
    4: [
        ...
        (13, "And many believers and saints having seen Him for whom they were hoping, who was crucified, Yeshua the Lord Christ, and those also who were believers in Him — of these few in those days will be left as His servants, while they flee from desert to desert, awaiting the coming of the Beloved."),
        ...
        (18, "Then the voice of the Beloved will in wrath rebuke the things of heaven and the things of the earth and the mountains and the hills and the cities and the desert and the forests and the angel of the sun and that of the moon, and all things wherein Beliar manifested himself and acted openly in this world, and there will be a resurrection and a judgment in their midst in those days, and the Beloved will cause fire to go forth from Him, and it will consume all the godless, and they will be as though they had not been created."),
    ...
    5: [
        (1,  "ON account of these visions, therefore, Beliar was wroth with Isaiah, and he dwelt in the heart of Manasseh and he sawed him in sunder with a wooden saw."),
        ...
        (9,  "And Isaiah answered and said: So far as I have utterance I say: Damned and accused be thou and all thy powers and all thy house."),
        ...
        (12, "And Manasseh and Belchira and the false prophets and the princes and the people all stood looking on."),
    ...
    6: [
        (1,  "The Vision Which Isaiah the Son of Amoz Saw: In the twentieth year of the reign of Hezekiah, king of Judah, came Isaiah the son of Amoz, and Josab the son of Isaiah to Hezekiah to Jerusalem from Galgala."),
        ...
        (8,  "And it came to pass when they had all heard the voice of the Holy Spirit, they all worshipped on their knees, and glorified the God of truth, the Most High who is in the upper world and who sits on High the Holy One and who rests among His holy ones."),
    ...
    7: [
        ...
        (2,  "At this moment, when I prophesied according to the words heard which ye heard, I saw a glorious angel not like unto the glory of the angels which I used always to see, but possessing such glory and position that I cannot describe the glory of that angel."),
        ...
        (4,  "And he said unto me: When I have raised thee on high through the various degrees and made thee see the vision, on account of which I have been sent, then thou wilt understand who I am: but my name thou dost not know."),
        ...
        (7,  "And he said unto me: Hast thou rejoiced because I have spoken courteously to thee? And he said: And thou wilt see how a greater also that I am will speak courteously and peaceably with thee."),
        ...
        (18, "And again, he made me to ascend to the second heaven. Now the height of that heaven is the same as from the heaven to the earth and to the firmament."),
        ...
        (21, "And I fell on my face to worship him, but the angel who conducted me did not permit me, but said unto me: Worship neither throne nor angel which belongs to the six heavens — for for this cause I was sent to conduct thee — until I tell thee in the seventh heaven."),
        ...
        (24, "And he raised me to the third heaven, and in like manner I saw those upon the right and upon the left, and there was a throne there in the midst; but the memorial of this world is there unheard of."),
        ...
        (27, "And I wished to learn how it is known, and he answered me saying: When I have raised thee to the seventh heaven whence I was sent, to that which is above these, then thou shalt know that there is nothing hidden from the thrones and from those who dwell in the heavens and from the angels. And the praise wherewith they praised and glory of him who sat on the throne was great, and the glory of the angels on the right hand and on the left was beyond that of the heaven which was below them."),
        (28, "And again he raised me to the fourth heaven, and the height from the third to the fourth heaven was greater than from the earth to the firmament."),
        ...
        (33, "And again I saw those upon the right hand and on the left, and him who sat on the throne possessing greater glory than those of the fourth heaven."),
    ...
    8: [
        ...
        (26, "Not yet hath been manifested he who shall be in the corruptible world, and the garments, and the thrones, and the crowns which are laid up for the righteous, for those who trust in that Lord who will descend in your form. For the light which is there is great and wonderful."),
    ...
    9: [
        ...
        (5,  "And He who permitted thee, this is thy Lord God, the Lord Christ, who will be called Yeshua in the world, but His name thou canst not hear till thou hast ascended out of thy body."),
        ...
        (9,  "But they sat not on their thrones, nor were their crowns of glory on them."),
        (10, "And I asked the angel who was with me: How is it that they have received the garments, but have not the thrones and the crowns?"),
        (11, "And he said unto me: Crowns and thrones of glory they do not receive, till the Beloved will descend in the form in which you will see Him descend into the world in the last days the Lord, who will be called Christ."),
        (12, "Nevertheless they see and know whose will be thrones, and whose the crowns when He has descended and been made in your form, and they will think that He is flesh and is a man."),
        (13, "And the god of that world will stretch forth his hand against the Son, and they will crucify Him on a tree, and will slay Him not knowing who He is."),
        (14, "And thus His descent, as you will see, will be hidden even from the heavens, so that it will not be known who He is."),
        (15, "And when He hath plundered the angel of death, He will ascend on the third day, and he will remain in that world five hundred and forty-five days."),
        (16, "And then many of the righteous will ascend with Him, whose spirits do not receive their garments till the Lord Christ ascend and they ascend with Him."),
        (17, "Then indeed they will receive their garments and thrones and crowns, when He has ascended into the seventh heaven."),
        (18, "And I said unto him that which I had asked him in the third heaven"),
        (19, "Show me how everything which is done in that world is here made known."),
        (20, "And whilst I was still speaking with him, behold one of the angels who stood nigh, more glorious than the glory of that angel, who had raised me up from the world."),
        (21, "Showed me a book, but not as a book of this world, and he opened it, and the book was written, but not as a book of this world. And he gave it to me and I read it, and lo! the deeds of the children of Israel were written therein, and the deeds of those whom I know not, my son Josab."),
        (22, "And I said: In truth, there is nothing hidden in the seventh heaven, which is done in this world."),
        (23, "And I saw there many garments laid up, and many thrones and many crowns."),
        (24, "And I said to the angel: Whose are these garments and thrones and crowns?"),
        (25, "And he said unto me: These garments many from that world will receive, believing in the words of That One, who shall be named as I told thee, and they will observe those things, and believe in them, and believe in His cross: for them are these laid up."),
        (26, "And I saw a certain One standing, whose glory surpassed that of all, and His glory was great and wonderful."),
        (27, "And after I had seen Him, all the righteous whom I had seen and also the angels whom I had seen came to Him. And Adam and Abel and Seth and all the righteous first drew near and worshipped Him, and they all praised Him with one voice, and I myself also gave praise with them, and my giving of praise was as theirs."),
        (28, "And then all the angels drew nigh and worshipped and gave praise."),
        (29, "And I was again transformed and became like an angel."),
        (30, "And thereupon the angel who conducted me said to me: Worship this One, and I worshipped and praised."),
        (31, "And the angel said unto me: This is the Lord of all the praise-givings which thou hast seen."),
        (32, "And whilst he was still speaking, I saw another Glorious One who was like Him, and the righteous drew nigh and worshipped and praised, and I praised together with them. But my glory was not transformed into accordance with their form."),
        (33, "And thereupon the angels drew near and worshipped Him."),
        (34, "And I saw the Lord and the second angel, and they were standing."),
        (35, "And the second whom I saw was on the left of my Lord. And I asked: Who is this? and he said unto me: Worship Him, for He is the angel of the Holy Spirit, who speaketh in thee and the rest of the righteous."),
        (36, "And I saw the great glory, the eyes of my spirit being open, and I could not thereupon see, nor yet could the angel who was with me, nor all the angels whom I had seen worshipping my Lord."),
        (37, "But I saw the righteous beholding with great power the glory of that One."),
        (38, "And my Lord drew nigh to me and the angel of the Spirit and He said: See how it is given to thee to see God, and on thy account power is given to the angel who is with thee."),
        (39, "And I saw how my Lord and the angel of the Spirit worshipped, and they both together praised God."),
        (40, "And thereupon all the righteous drew near and worshipped."),
        (41, "And the angels drew near and worshipped and all the angels praised."),
    ],
    10: [
        ...
        (7,  "And I heard the voice of the Most High, the Father of my Lord, saying to my Lord Christ who will be called Yeshua"),
        ...
        (12, "And they shall not know that Thou art with Me, till with a loud voice I have called to the heavens, and their angels and their lights, even unto the sixth heaven, in order that thou mayest judge and destroy the princes and angels and gods of that world, and the world that is dominated by them"),
        ...
        (18, "And the angel who conducted me said unto me: Understand, Isaiah, and see the transformation and descent of the Lord will appear."),
    ...
    11: [
        ...
        (40, "Such things ye will read. And watch ye in the Holy Spirit in order that ye may receive your garments and thrones and crowns of glory which are laid up in the seventh heaven."),
...
def main():
    # Remove stale DB files, preserve .bak
    for ext in ('', '-shm', '-wal'):
        p = DB + ext
        if os.path.exists(p):
            os.remove(p)
    ...
    # Fresh backup of old DB before anything (may already exist; overwrite)
    # (old DB already gone above — backup is the previous .bak or nothing)

    conn = sqlite3.connect(DB)
    conn.executescript(SCHEMA)
    conn.execute(
        "INSERT INTO books VALUES ('AIS','Ascension of Isaiah','Asc.Isa','Pseudepigrapha',11)"
    )
    ...
    for ch in range(1, 12):
        ...
        for v_num, text in verses:
            conn.execute(
                "INSERT INTO verses (book_id,chapter,verse_num,text) VALUES ('AIS',?,?,?)",
                (ch, v_num, text)
            )
            total += 1
        print(f'  Chapter {ch:2d}: {len(verses)} verses')

    conn.commit()
    conn.close()
    print(f'\nAscension of Isaiah reseeded: 11 chapters, {total} verses')
